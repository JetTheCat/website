    ...
    render() {
        return (
            <div id="ass2511-container" className={(this.props.status) ? "ass2511-open" : "ass2511-close"}>
                ...
                <h1>Dungeon Game with Object Oriented Design Programming</h1>
                ...
                <div className="ass2511-box">
                    ...
                    <div>
                        <img src={mil1_0} alt="img" className="ass2511-img"/>
                    </div>

                    <div>
                        <img src={mil1_1} alt="img" className="ass2511-img"/>
                    </div>
                </div>
                ...
                <div className="ass2511-box">
                    ...
                    <div>
                        <img src={mil2_1} alt="img" className="ass2511-img"/>
                    </div>
                    <div>
                        <img src={mil2_0} alt="img" className="ass2511-img"/>
                        <img src={mil2_2} alt="img" className="ass2511-img"/>
                    </div>
                </div>
                ...
                <div className="ass2511-box">
                    ...
                    <div>
                        <img src={mil3_0} alt="img" className="ass2511-img"/>
                    </div>
                    <div>
                        <img src={mil3_1} alt="img" className="ass2511-img"/>
                    </div>
                </div>
